...
export default function EditVehiclePage() {
  ...
  return (
    ...
    <Select value={formData.transmission || "none"} onValueChange={(value) => {
      const actualValue = value === "none" ? "" : value;
      setFormData(prev => ({ ...prev, transmission: actualValue }));
    }}>
    <SelectTrigger>
    ...
    <Select value={formData.fuelType || "none"} onValueChange={(value) => {
      const actualValue = value === "none" ? "" : value;
      setFormData(prev => ({ ...prev, fuelType: actualValue }));
    }}>
    <SelectTrigger>
    ...
    <Select value={formData.clientId || "none"} onValueChange={(value) => {
      const actualValue = value === "none" ? "" : value;
      setFormData(prev => ({ ...prev, clientId: actualValue }));
    }}>
    <SelectTrigger>
    ...
    <Select value={formData.assignedToId || "none"} onValueChange={(value) => {
      const actualValue = value === "none" ? "" : value;
      setFormData(prev => ({ ...prev, assignedToId: actualValue }));
    }}>
    <SelectTrigger>
